...
To contribute to tasks project on [GitHub](https://github.com/InfosisARG/tasks), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/InfosisARG/tasks/pulls).
...
```bash
git remote add upstream  https://github.com/InfosisARG/tasks.git
```

Now your **upstream** points to **InfosisARG/tasks**.
...
git fetch upstream # assuming upstream is InfosisARG/tasks
...
All merge requests are automatically tested using [Github Actions](https://github.com/InfosisARG/tasks/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
